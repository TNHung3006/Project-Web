...
namespace Hung_Tran_Ngoc_66131218_Web_QLBH.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        //4. Gian Hàng
        public DbSet<GianHang> gh { get; set; }
        //5. Tỉnh
        ...
        //4. Gian Hàng
        //4.1.
        public List<GianHang> GianHang_GetAll()
        {

            return gh.FromSqlRaw("EXEC GianHang_GetAll").ToList();
        }
        //4.2.
        public GianHang? GianHang_GetById(int gianhang)
        {
            var p = new[]
            {
                new SqlParameter("@MaGH", gianhang)
            };
            return gh.FromSqlRaw("EXEC GianHang_GetById @MaGH", p).ToList().FirstOrDefault();
        }

        //4.3.
        public void GianHang_Insert(GianHang gh)
        {
            var p = new[]
            {
                new SqlParameter("@TenGH", gh.TenGH),
                new SqlParameter("@MaXa", gh.MaXa)
            };
            Database.ExecuteSqlRaw("EXEC GianHang_Insert @TenGH, @MaXa", p);

        }

        //4.4.
        public void GianHang_Update(GianHang gh)
        {
            var p = new[]
            {
            ...
            Database.ExecuteSqlRaw("EXEC GianHang_Update @MaGH, @TenGH, @MaXa", p);
        }

        //4.5.
        public void GianHang_Delete(int gh)
        {
            var p = new SqlParameter("@MaGH", gh);
            Database.ExecuteSqlRaw("EXEC GianHang_Delete @MaGH", p);
        }
        ...
        public string KhachHang_Insert(KhachHang khachHang)
        {
            ...
            cmd.Parameters.Add(new SqlParameter("@AnhSP", khachHang.AnhKH ?? (object)DBNull.Value));
