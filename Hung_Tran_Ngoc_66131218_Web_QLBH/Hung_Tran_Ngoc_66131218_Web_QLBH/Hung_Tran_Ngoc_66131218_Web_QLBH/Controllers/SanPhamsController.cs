...
namespace Hung_Tran_Ngoc_66131218_Web_QLBH.Controllers
{
    public class SanPhamsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            //Xử lý MaGH
            var ghList = _db.GianHang_GetAll() ?? new List<GianHang>(); // Đảm bảo không null
            ViewBag.GianHangs = new SelectList(ghList, "MaGH", "TenGH");
        ...
        public IActionResult Edit(string id)
        {
            ...
            //Xử lý MaGH (Mã Gian Hàng)
            var ghList = _db.GianHang_GetAll() ?? new List<GianHang>(); // Đảm bảo không null
            // Truyền MaGH hiện tại của sản phẩm để chọn giá trị mặc định
            ViewBag.GianHangs = new SelectList(ghList, "MaGH", "TenGH", sp.MaGH);
